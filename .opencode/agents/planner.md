...
| standard | Normal feature, multiple files, one app, may need spec | architect, coder, validator, tester, documenter |
| complex | Multi-service, migrations, API changes, new agents | architect, coder, validator, tester, documenter, auditor |
...
- If an existing OpenSpec proposal covers this task, note it in reasoning
